...
@Component({
  selector: 'app-word-card-no-header',
  templateUrl: './word-card-no-header.component.html',
  styleUrls: ['./word-card-no-header.component.css']
})
export class WordCardNoHeaderComponent {
